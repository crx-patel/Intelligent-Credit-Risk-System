...
# #     tab_home, tab_whatif, tab_report, tab_download, tab_history = st.tabs([
# #         "🏠 Home", "🤔 What-If Simulator", "📄 View Report", "⬇️ Download PDF", "📅 Loan History",
# #     ])
...
# #             # Only Risk Category + Score — NO Fraud Status
...
#     tab_home, tab_whatif, tab_report, tab_download, tab_history, tab_cc = st.tabs([
#         "🏠 Home", "🤔 What-If Simulator", "📄 View Report", "⬇️ Download PDF", "📅 Loan History", "💳 Credit Card",
#     ])
...
#             st.error(f"❌ Could not load history: {e}")
#     # ══════════════════════════════════════════════════════════════════════════
#     # TAB 6 — CREDIT CARD ELIGIBILITY (Customer View)
#     # ══════════════════════════════════════════════════════════════════════════
#     with tab_cc:
...
#             # ── Risk progress bar (simple, customer-friendly) ───────────────
